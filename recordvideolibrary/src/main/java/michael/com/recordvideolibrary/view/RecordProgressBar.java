...
public class RecordProgressBar extends View {
    ...
    // 默认运行时间
    private static final int DEFAULT_RUNNING_TIME = 21;
    // 默认背景颜色
...
//        mRunSpeed = dm.widthPixels / 2f / mRunningTime;
        mRunSpeed = dm.widthPixels / mRunningTime;//修改为单向进度
...
//            canvas.drawRect(left, 0, right, canvas.getHeight(), mPaint);//双向进度，从两边向中间缩减
            canvas.drawRect(0, 0, left, canvas.getHeight(), mPaint);//单向进度，从右向左缩减
        }
    }
